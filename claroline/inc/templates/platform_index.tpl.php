...
<div class="row">
    ...
    include_textzone( 'textzone_top.inc.html', '<div style="width: 50%;margin: auto;">
    <img width="100%" src="'.get_icon_url('aula-grupo-ro-logo-02').'" border="0" alt="Aula Grupo RO logo" />
    ...
    <div id="rightSidebar" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		...
		<?php else : ?>
			<?php if (!empty($this->languages) && count($this->languages) > 1) : ?>
                ...
                <div id="languageBox" style="width: 100%">
