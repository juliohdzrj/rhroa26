...
<?php if ( claro_is_in_a_course() && $this->courseTitleAndTools ): ?>
    ...
    <div style="border:none !important" class="tabbedCourse<?php if ($this->course['isSourceCourse']) : ?> sourceCourse<?php endif; ?>">
    </div> <!-- tabedCourse -->
...
<div class="row">
            ...
            <div id="courseLeftSidebar" class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                <!--div class="toolList"-->
            ...
            <div id="courseRightContent" class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
