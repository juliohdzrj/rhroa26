...
$_lang['%name should be boolean'] = '%name debería ser un valor lógico';
...
$_lang['%nb category(ies)'] = '%nb categoría(s)';
$_lang['%nb class(es)'] = '%nb clase(s)';
$_lang['%nb course(s)'] = '%nb curso(s)';
$_lang['%nb course(s) manager(s)'] = '%nb profesor(es)';
...
$_lang['Accounts with same <i>Username</i>'] = 'Cuentas con el mismo <i>Nombre de Usuario</i>';
$_lang['Accounts with same <i>Username</i> AND same <i>Password</i>'] = 'Cuentas con el mismo <i>Nombre de Usuario</i> y misma <i>Clave</i>';
$_lang['Action'] = 'Rol';
...
$_lang['Add a portlet to your course homepage'] = 'Añadir un elemento de portada';
$_lang['Add a specific comment to this module'] = 'Añadir un comentario propio para este módulo';
...
$_lang['Add announcement'] = 'Añadir anuncio';
$_lang['Add answ.'] = '+resp';
$_lang['Add elem.'] = '+elem';
...
$_lang['Add feedback'] = 'Añadir revisión';
$_lang['Add forum'] = 'Crear foro';
$_lang['Add me to this group'] = 'Apuntarse al grupo';
...
$_lang['Add new profile'] = 'Crear perfil';
$_lang['Add or remove tools'] = 'Selección de herramientas';
$_lang['Add or remove tools from your course'] = 'Añadir o quitar herramientas al curso';
$_lang['Add selected users'] = 'Añadir los usuarios seleccionados';
$_lang['Add selection'] = 'Añadir selección';
...
$_lang['Administration modules'] = 'Módulos de administración';
$_lang['Administration tools'] = 'Herramientas de administración';
$_lang['Administrative code'] = 'Código';
...
$_lang['Advanced options'] = 'Configuración avanzada';
...
$_lang['Agreement text displayed before the "Create user account" page'] = 'Condiciones de uso a mostrar antes de «Crear cuenta de usuario»';
$_lang['Alignment'] = 'Alineación';
$_lang['All'] = 'Todos';
$_lang['All (Read or not)'] = 'Todos (leídos o no)';
$_lang['All categories'] = 'Todas las categorías';
$_lang['All classes deleted'] = 'Eliminadas todas las clases';
$_lang['All classes emptied'] = 'Vaciadas todas las clases';
$_lang['All courses treated !'] = '¡Procesados todos los cursos!';
...
$_lang['All modules of this course are already used in this learning path.'] = 'Todos los módulos del curso están ya en esta secuencia de aprendizaje.';
...
$_lang['Allowed with enrolment key'] = 'Por contraseña';
$_lang['Allowed with validation'] = 'Con validación previa';
$_lang['Alphabetical ascending'] = 'Orden alfabético ascendente';
$_lang['Alphabetical descending'] = 'Orden alfabético descendente';
$_lang['Already browsed'] = 'Ya ha sido hojeado';
$_lang['Already enroled'] = 'Ya está inscrito';
$_lang['Also delete module main database'] = 'Eliminar también la base de datos principal del módulo';
...
$_lang['Announcements list has been cleared up'] = 'La lista de anuncios se ha borrado.';
$_lang['Anonymity'] = 'Anonimato';
$_lang['Anonymous'] = 'Anónimo';
$_lang['Anonymous attempts'] = 'Intentos anónimos';
$_lang['Anonymous contribution'] = 'Contribución anónima';
$_lang['Anonymous contributor wrote :'] = 'Un contribuyente anónimo escribió :';
$_lang['Anonymous post'] = 'Envío anónimo';
...
$_lang['Are you sure to delete course %name'] = '¿ Está seguro de querer borrar el curso %name ?';
...
$_lang['Are you sure to delete this group ?'] = '¿ Seguro que quiere eliminar este grupo ?';
$_lang['Are you sure to delete user %firstname %lastname'] = '¿ Seguro que quiere eliminar el usuario %firstname %lastname ?';
$_lang['Are you sure to empty trashbox ?'] = '¿ Seguro que quiere vaciar la papelera ?';
$_lang['Are you sure you want to completely delete this question ?'] = '¿ Seguro que quiere eliminar completamente esta pregunta ?';
$_lang['Are you sure you want to delete all groups ?'] = '¿ Seguro que quiere eliminar todos los grupos ?';
$_lang['Are you sure you want to delete all the announcements ?'] = '¿ Seguro que quiere eliminar todos los anuncios ?';
$_lang['Are you sure you want to delete module %module% ?'] = '¿ Seguro que quiere eliminar el módulo %module% ?';
$_lang['Are you sure you want to delete this category ?'] = '¿ Seguro que quiere eliminar esta categoría ?';
$_lang['Are you sure you want to delete this exercise ?'] = '¿ Seguro que quiere eliminar este ejercicio ?';
$_lang['Are you sure you want to empty all groups ?'] = '¿ Seguro que quiere vaciar todos los grupos ?';
...
$_lang['Assignment end date delay'] = 'Tiempo de entrega preestablecido';
$_lang['Assignment modified'] = 'Trabajo modificado';
$_lang['Assignment property "Default works visibility" acts'] = 'La opción «Visibilidad por defecto de los trabajos» afecta a';
...
$_lang['Attached resources'] = 'Recursos adjuntos';
$_lang['Attempt %attemptCount on %attempts'] = 'Intento %attemptCount de %attempts';
$_lang['Attempts'] = 'Intentos';
$_lang['Attempts allowed'] = 'Intentos permitidos';
$_lang['Authentication'] = 'Inicio de sesión';
$_lang['Authentication Required'] = 'Se requiere iniciar sesión';
$_lang['Authentication source'] = 'Fuentes de autentificación';
$_lang['Author'] = 'Autor';
$_lang['Author(s)'] = 'Autor(es)';
$_lang['Authorize the category to possess courses or not (opened or closed category)'] = 'Autorizar que la categoría tenga cursos o no (categoría abierta o cerrada).';
$_lang['Auto discover authentication drivers in platform/conf/extauth'] = 'Detectar controladores de autenticación en platform/conf/extauth';
$_lang['Automatic'] = 'Automático';
$_lang['Automatic cleaning factor'] = 'Factor de limpieza automático';
$_lang['Automatically insert an event in the calendar at the end date'] = 'Inserta automáticamente un evento de calendario con la fecha límite de entrega.';
$_lang['Automatically insert an event in the calendar at the submission date'] = 'Inserta automáticamente un evento de calendario en la fecha de remisión';
$_lang['Automatically, after each submission'] = 'Automáticamente, después de cada envío';
...
$_lang['Back to course homepage'] = 'Volver a la página de inicio';
$_lang['Back to course list'] = 'Volver a la lista de cursos del usuario';
$_lang['Back to inbox'] = 'Volver a la bandeja de entrada';
$_lang['Back to learning path administration'] = 'Secuencia de aprendizaje';
$_lang['Back to list'] = 'Volver a la lista';
$_lang['Back to module list'] = 'Lista de módulos';
...
$_lang['Back to user settings'] = 'Volver a editar usuario';
...
$_lang['Basic settings'] = 'Configuración básica';
...
$_lang['Campus banner - left'] = 'Cartel del campus - izquierda';
$_lang['Campus banner - right'] = 'Cartel del campus - derecha';
$_lang['Campus footer - center'] = 'Pie de página del campus - centro';
...
$_lang['Can\'t create this portlet (%portlet)'] = 'No se pudo crear el elemento en portada (%portlet)';
$_lang['Can\'t find the class %portletName_portlet'] = 'No se pudo encontrar la clase %portletName_portlet';
$_lang['Cancel'] = 'Cancelar';
$_lang['Cancel the operation'] = 'Cancelar la operación';
$_lang['Cannot activate module'] = 'No se puede activar el módulo';
...
$_lang['Cannot merge one user account with itself'] = 'No se puede combinar una cuenta de usuario consigo misma';
...
$_lang['Category visibility'] = 'Visibilidad de la categoría';
...
$_lang['Class has been enroled'] = 'La clase ha quedado inscrita';
...
$_lang['Course creation is allowed on the platform'] = 'Está permitida la creación de cursos';
$_lang['Course creation is disabled on the platform'] = 'Está deshabilitada la creación de cursos';
$_lang['Course creator'] = 'Creador de cursos';
$_lang['Course creator status for %firstname %lastname'] = 'Condición de creador de cursos %firstname %lastname';
$_lang['Course deactivated'] = 'Curso desactivado';
$_lang['Course default settings'] = 'Opciones de acceso predeterminadas';
$_lang['Course description'] = 'Descripción del curso';
$_lang['Course email is'] = 'El correo electrónico del curso es';
$_lang['Course homepage'] = 'Página de inicio del curso';
$_lang['Course information requirements'] = 'Requisitos de información del curso';
$_lang['Course language selector'] = 'Selección de idiomas de cursos';
$_lang['Course list'] = 'Lista de cursos';
$_lang['Course main settings'] = 'Configuración principal del curso';
$_lang['Course management tools'] = 'Herramientas de gestión de cursos';
$_lang['Course manager'] = 'Coordinador del curso';
$_lang['Course manager cannot unsubscribe himself'] = 'Un profesor no puede darse de baja a si mismo';
...
$_lang['Course profile'] = 'Perfil';
$_lang['Course profile list'] = 'Lista de perfiles';
$_lang['Course progression'] = 'Progreso del curso';
$_lang['Course registration settings'] = 'Opciones de inscripción';
$_lang['Course session creation is allowed on the platform'] = 'Permitir crear sesiones';
$_lang['Course settings'] = 'Configuración del curso';
$_lang['Course statistics are now empty'] = 'Las estadísticas del curso están ahora vacías';
$_lang['Course title'] = 'Curso';
$_lang['Course title needed'] = 'Se necesita el título del curso';
$_lang['Course tools'] = 'Herramientas del curso';
$_lang['Course tutor'] = 'Tutor de curso';
...
$_lang['Create a category'] = 'Crear categoría';
$_lang['Create a course site'] = 'Crear curso';
$_lang['Create a course website'] = 'Crear curso';
$_lang['Create a new Wiki'] = 'Crear wiki';
$_lang['Create a new assignment'] = 'Crear trabajo';
$_lang['Create a new class'] = 'Crear clase';
$_lang['Create a new label / title in this learning path'] = 'Crear una nueva etiqueta / título en esta secuencia de aprendizaje';
$_lang['Create a new learning path'] = 'Crear secuencia de aprendizaje';
$_lang['Create a new user'] = 'Crear usuario';
$_lang['Create a session course'] = 'Crear sesión del curso';
$_lang['Create another new user'] = 'Crear otro usuario';
$_lang['Create category'] = 'Crear categoría';
$_lang['Create course'] = 'Crear curso';
$_lang['Create courses'] = 'Creación y gestión de cursos';
...
$_lang['Create hyperlink'] = 'Crear enlace';
$_lang['Create item into courses tools'] = 'Crear elemento en las herramientas de los cursos';
$_lang['Create label'] = 'Crear etiqueta';
$_lang['Create new group(s)'] = 'Crear nuevo(s) grupo(s)';
$_lang['Create user'] = 'Crear usuario';
$_lang['Create user account'] = 'Crear cuenta de usuario';
...
$_lang['Database update successful'] = 'Actualizada con éxito la base de datos';
$_lang['Date'] = 'Fecha';
$_lang['Day'] = 'Día';
...
$_lang['Dear %firstname %lastname, your personal settings have been registered.'] = 'Hola %firstname %lastname, su configuración personal ya ha sido registrada.';
$_lang['Debug'] = 'Depuración';
$_lang['Debug mode'] = 'Modo de depuración';
$_lang['Dedicate a course to this category.  The course has to be linked to the category first.'] = 'Dedicar un curso a esta categoría. El curso tiene que haber sido previamente asociado a la categoría.';
$_lang['Dedicated course'] = 'Curso dedicado';
...
$_lang['Delete all classes'] = 'Eliminar todas las clases';
$_lang['Delete all classes ?'] = '¿Desea eliminar todas las clases?';
...
$_lang['Delete messages'] = 'Eliminar mensajes';
$_lang['Delete messages older than'] = 'Eliminar mensajes anteriores a';
$_lang['Delete my account'] = 'Eliminar mi cuenta';
$_lang['Delete picture'] = 'Eliminar imagen';
$_lang['Delete platform messages'] = 'Eliminar mensajes de la plataforma';
$_lang['Delete scripts of the module'] = 'Eliminar scripts del módulo';
$_lang['Delete selected message(s)'] = 'Eliminar mensaje(s) seleccionado(s)';
$_lang['Delete the whole course website'] = 'Eliminar la web de este curso';
$_lang['Delete this item'] = 'Eliminar este elemento';
$_lang['Delete user'] = 'Eliminar usuario';
$_lang['Deleted line'] = 'Línea eliminada';
$_lang['Deleting this course will permanently delete all its documents and unenroll all its students.'] = 'Borrar el curso eliminará todos sus documentos y dará de baja a todos los participantes.';
...
$_lang['Denotes required fields'] = 'Campo obligatorio';
...
$_lang['Department name'] = 'El nombre del departamento es';
$_lang['Department needed'] = 'Se necesita un departamento';
$_lang['Department url needed'] = 'Se necesita la URL del departamento';
$_lang['Department website'] = 'El sitio web del departamento';
$_lang['Description'] = 'Descripción';
$_lang['Description added'] = 'Descripción añadida';
$_lang['Description deleted.'] = 'Descripción eliminada.';
...
$_lang['Element renamed'] = 'Elemento renombrado';
...
$_lang['Enable Ajax Remote Service broker'] = 'Habilitar el gestor de servicio remoto AJAX';
...
$_lang['Enrol as course manager'] = 'Inscribir como profesor coordinador del curso';
$_lang['Enrol as student'] = 'Inscribir como participante';
...
$_lang['Error : Cannot initialize chat'] = 'Error: no se puede inicializar la conversación';
$_lang['Error : Category not found'] = 'Error: categoría desconocida';
$_lang['Error : Class has sub-classes'] = 'Error: La clase tienen sub-clases';
$_lang['Error : Class not found'] = 'Error: clase desconocida';
$_lang['Error : Name already exists in the learning path or in the module pool'] = 'Error: el nombre ya existe';
$_lang['Error : One or more values are doubled'] = 'Error: uno o más valores están repetidos';
$_lang['Error : cannot read RSS feed (Check feed url and if php setting "allow_url_fopen" is turned on).'] = 'Error: no se puede obtener RSS. Comprobar la fuente RSS y si la opción de PHP «allow_url_fopen» está activa.';
...
$_lang['Error reading zip file.'] = 'Error al leer el archivo comprimido en ZIP.';
...
$_lang['Expand all'] = 'Expandir todo';
$_lang['Expected choice'] = 'Elección esperada';
$_lang['Expiration date needed'] = 'Se necesita la fecha de caducidad';
...
$_lang['False'] = 'Falso';
$_lang['Feedback'] = 'Revisión';
$_lang['Feedback added'] = 'Revisión añadida';
$_lang['Feedback edited'] = 'Se ha editado la revisión';
$_lang['Feedback file'] = 'Archivo de revisión';
$_lang['Feedback text'] = 'Texto de la revisión';
$_lang['Feedbacks'] = 'Revisiones';
$_lang['Feel free not to associate courses to any categories.'] = 'No es necesario asociar el curso a ninguna categoría.';
$_lang['Fetch and install module'] = 'Descargar e instalar el módulo';
...
$_lang['File'] = 'Archivo';
$_lang['File (file required, description text optional)'] = 'Archivo (archivo requerido, descripción opcional)';
$_lang['File Name or URL is missing.'] = 'Falta el nombre o la URL.';
$_lang['File cannot be moved there'] = 'El archivo no puede moverse aquí';
...
$_lang['File download failed : %failureMSg%'] = 'La descarga del archivo ha fallado: %failureMSg%';
...
$_lang['File system settings'] = 'Sistema de archivos';
$_lang['File too large. Notice : Max file size %size'] = 'Archivo demasiado grande. Nota : Tamaño máx de archivo %size';
$_lang['File upload failed'] = 'Falló la subida del archivo';
$_lang['File upload incomplete'] = 'No se completó el proceso de subir el archivo';
$_lang['File url mode'] = 'Apariencia del enlace';
...
$_lang['Files extensions'] = 'Extensiones de archivo';
$_lang['Files statistics'] = 'Estadísticas de archivos';
$_lang['Fill courses tools with material example'] = 'Rellenar herramientas de curso con materiales de ejemplo';
...
$_lang['Find more available modules on <a href="http://www.claroline.net/">Claroline.net</a>.'] = 'Encuentre más módulos en <a href="http://www.claroline.net/">Claroline.net</a>.';
...
$_lang['Forum index'] = 'Índice del foro';
$_lang['Forum locked'] = 'Foro bloqueado';
$_lang['Forum name cannot be empty'] = 'El nombre del foro no puede quedar vacío';
$_lang['Forum unknown'] = 'Foro desconocido';
$_lang['Forum updated'] = 'Foro actualizado';
$_lang['Forums'] = 'Foros';
$_lang['Forums help'] = 'Ayuda sobre foros';
$_lang['From'] = 'De';
...
$_lang['Generate RDF file'] = 'Generar archivo RDF';
$_lang['Generate Xml file'] = 'Generar archivo XML';
$_lang['Generate an event in the calendar'] = 'Crear un evento en el calendario';
...
$_lang['Give a port number used to contact SMTP the SMTP server(s) if no port is specified in the hostname (default: 25)'] = 'Indique el puerto a utilizar para acceder al servidor o servidores SMTP cuando no se especifique en el propio nombre anterior (puerto por defecto: 25)';
...
$_lang['Global settings'] = 'Opciones comunes';
$_lang['Go'] = 'Ir';
...
$_lang['Group area'] = 'Zona del grupo';
...
$_lang['Hidden'] = 'Oculto';
$_lang['Hide course categories to anonymous'] = 'Ocultar las categorías de cursos a usuarios anónimos';
...
$_lang['Import a learning path'] = 'Importar secuencia de aprendizaje';
...
$_lang['Impossible to promote as a group tutor a student who is already registered in the group'] = 'Imposible promocionar a tutor de grupo a un participante ya pertenece a un  grupo';
...
$_lang['Introduction moved down'] = 'Elemento bajado';
$_lang['Introduction moved up'] = 'Elemento subido';
$_lang['Introduction\' visibility modified'] = 'Cambiada la visibilidad del elemento';
...
$_lang['Invalid email address at line %key'] = 'Dirección de correo electrónico no válida en la línea %key';
$_lang['Invalid enrolment key given'] = 'Invalid enrolment key given';
$_lang['Invalid file format, use gif, jpg or png'] = 'Formato de archivo no válido. Utilice JPEG, PNG o incluso GIF.';
...
$_lang['Lines'] = 'Líneas';
$_lang['Linked categories'] = 'Categorías asociadas';
...
$_lang['Loaded extensions'] = 'Extensiones de PHP';
$_lang['Loading'] = 'Loading';
$_lang['Local settings'] = 'Opciones particulares';
...
$_lang['Logout'] = 'Salir';
$_lang['Logout user from CAS server when user logout from Claroline'] = 'Cerrar sesión de usuario en el servidor CAS cuando el usuario cierre sesión en Claroline';
...
$_lang['Mail notification'] = 'Enviar mensajes de notificación';
$_lang['Mail notification mode'] = 'Enviar notificaciones por correo electrónico';
$_lang['Mail sent to user'] = 'Mensaje enviado al usuario';
$_lang['Mail server configuration'] = 'Configuración del servidor de correo electrónico saliente';
$_lang['Mail synthax error.'] = 'Error de sintaxis en la dirección de correo electrónico';
$_lang['Main'] = 'Principal';
$_lang['Main Group Settings'] = 'Opciones de grupos';
$_lang['Main database name'] = 'Nombre de la base de datos principal';
$_lang['Main page'] = 'Página de inicio';
$_lang['Main settings'] = 'Opciones de configuración';
...
$_lang['Make new search'] = 'Buscar';
$_lang['Make search'] = 'Buscar';
$_lang['Make this tool activable only by the platform administrator <small>(available if the previous option is checked)</small>'] = 'Hacer esta herramienta activable solo por el administrador <small>(disponible si está marcada la anterior)</small>';
$_lang['Make visible'] = 'Hacer visible';
$_lang['Makes TinyMCE 75% smaller and a lot faster to load.'] = 'Hace que TinyMCE sea un 75% más pequeño y mucho más rápido de cargar.';
$_lang['Manage'] = 'Administrar';
$_lang['Manage Right'] = 'Administrar permisos';
$_lang['Manage administrator email notifications'] = 'Notificaciones del sistema';
$_lang['Manage classes'] = 'Lista de clases';
$_lang['Manage course categories'] = 'Administrar categorías de cursos';
$_lang['Manage external links'] = 'Enlaces externos';
$_lang['Manage my account'] = 'Administrar mi cuenta';
$_lang['Manage my courses'] = 'Administrar mis cursos';
$_lang['Manage platform'] = 'Administrar plataforma';
$_lang['Manage session courses'] = 'Administrar sesiones del curso';
$_lang['Manage the home page\'s display'] = 'Administrar la apariencia de la página de inicio';
$_lang['Manage tool access rights'] = 'Derechos de acceso';
...
$_lang['Manifest found in zip file :'] = 'Manifiesto encontrado en un archivo comprimido :';
$_lang['Manifest missing : %filename'] = 'Manifiesto perdido : %filename';
$_lang['Manifest read.'] = 'Manifiesto leído.';
$_lang['Manual'] = 'Manual';
$_lang['Match the exact expression'] = 'Casar la expresión exacta';
$_lang['Matching'] = 'Relacionar';
$_lang['Mathematical renderer URL'] = 'URL del procesador para matemáticas';
$_lang['Max announcement number in portlet'] = 'Número máximo de anuncios en portada';
...
$_lang['Maximum lines in the active chat file. For performance, it\'s interesting to not work with too big file.'] = 'Cantidad máxima de líneas en el archivo de la conversación activa. Para un mejor renimiento, se recomienda no trabajar con un archivo muy grande.';
$_lang['Maximum number of students'] = 'Número máximo de participantes';
$_lang['Maximum score'] = 'Puntuación máxima';
$_lang['Maximum size for an assignment'] = 'Tamaño máximo para una tarea';
$_lang['Maximum size of a document that a user can upload'] = 'Tamaño máximo de los archivos subidos';
$_lang['Memorize them, you will use them the next time you will enter to this site.'] = 'Memorícelos, los usará la próxima vez que acceda a este sitio.';
$_lang['Merge'] = 'Combinar';
$_lang['Merge user accounts'] = 'Combinar cuentas de usuario';
$_lang['Merging user accounts is not a reversible operation so be careful !'] = 'La fusión de cuentas de usuario no es una operación reversible, ¡tenga cuidado!';
...
$_lang['Message list refresh time'] = 'Tiempo de refresco para mensajes';
...
$_lang['Module activation at course creation set to AUTOMATIC'] = 'Activación del módulo al crear cursos establecida a AUTOMÁTICO';
$_lang['Module activation at course creation set to MANUAL'] = 'Activación del módulo al crear cursos establecida a MANUAL';
...
$_lang['Module desactivation succeeded'] = 'Módulo desactivado con éxito';
$_lang['Module directory not found'] = 'No se encuentra el directorio del módulo';
$_lang['Module edition'] = 'Edición del módulo';
...
$_lang['Module installation succeeded'] = 'Instalado con éxito el módulo';
$_lang['Module installed in all courses'] = 'El módulo está instalado en todos los cursos';
$_lang['Module list'] = 'Módulos';
$_lang['Module moved'] = 'Módulo movido';
$_lang['Module name'] = 'Módulo';
$_lang['Module registration failed'] = 'Falló el registro del módulo';
...
$_lang['Module uninstallation succeeded'] = 'Módulo desinstalado con éxito';
...
$_lang['Module upload failed'] = 'Falló la subida del módulo';
$_lang['Module visibility updated'] = 'Se ha actualizado la visibilidad del módulo';
$_lang['Modules'] = 'Módulos';
$_lang['Modules of this path will still be available in the pool of modules'] = 'Los módulos de esta secuencia se conservarán en el repositorio de módulos';
$_lang['Month'] = 'Mes';
$_lang['More active topics'] = 'Temas más activos';
$_lang['More information'] = 'Más información';
$_lang['More read topics'] = 'Temas más leídos';
...
$_lang['My %numberOfMessages last messages'] = 'Mis %numberOfMessages últimos mensajes';
...
$_lang['New headline'] = 'Nuevo titular';
$_lang['New introduction'] = 'Nueva introducción';
...
$_lang['New topic title'] = 'Título del nuevo tema';
$_lang['New users will receive an e-mail with their username and password'] = 'Los usuarios nuevos recibiran un correo electrónico con su nombre de usuario y su contraseña';
...
$_lang['Next course events'] = 'Próximos eventos del curso';
...
$_lang['No XML file found in the zip'] = 'No se ha encontrado ningún archivo XML en el zip';
$_lang['No access'] = 'Sin acceso';
$_lang['No announcement'] = 'No hay anuncios';
$_lang['No announcement to display'] = 'Ningún anuncio que mostrar';
$_lang['No category'] = 'Sin categoría';
$_lang['No category for this user'] = 'No category for this user';
$_lang['No change'] = 'Sin cambios';
...
$_lang['No course'] = 'Sin curso';
$_lang['No course available fitting this keyword'] = 'No hay ningún curso disponible con esas características';
...
$_lang['No description'] = 'Sin descripción';
$_lang['No description given'] = 'No description given';
$_lang['No dock chosen'] = 'No se eligió ningún apilable';
$_lang['No dock selected'] = 'No se eligió ningún apilable';
...
$_lang['No image to display'] = 'Sin imágenes que mostrar';
$_lang['No language folder'] = 'Sin carpeta de idioma';
$_lang['No learning path'] = 'Sin secuencia de aprendizaje';
$_lang['No mail sent to user'] = 'No se ha enviado el correo al usuario';
$_lang['No message'] = 'Sin mensajes';
$_lang['No mime-type available'] = 'No mime-type available';
$_lang['No module'] = 'Sin módulos';
$_lang['No module in package'] = 'Sin módulos en el paquete';
$_lang['No module to uninstall'] = 'Sin módulos que desinstalar';
$_lang['No more portlet available for this course'] = 'Sin elementos de portada disponibles para el curso';
$_lang['No name'] = 'Sin nombre';
$_lang['No new post allowed'] = 'no se permiten nuevos envíos';
$_lang['No post'] = 'No hay mensajes';
$_lang['No question to display'] = 'Ninguna pregunta que mostrar';
$_lang['No quota'] = 'Sin cuota';
$_lang['No reply email address'] = 'Correo electrónico de no-respuesta';
$_lang['No result'] = 'No hay resultados';
$_lang['No results available'] = 'Sin datos';
$_lang['No score'] = 'No hay puntuación';
$_lang['No session course'] = 'No hay sesión de curso';
$_lang['No time limitation'] = 'Sin límite de tiempo';
$_lang['No title'] = 'No title';
$_lang['No tool name'] = '(Sin nombre)';
...
$_lang['Not recently connected students :'] = 'Participantes que no se han conectado recientemente: ';
$_lang['Not restricted'] = 'Sin restricción';
...
$_lang['Notify students of feedbacks'] = 'Avisar a los estudianes de revisiones';
$_lang['Now'] = 'Ahora';
$_lang['Number of access'] = 'Número de accesos';
...
$_lang['Options for announcements portlet'] = 'Opciones para el elemento de portada de anuncios';
$_lang['Order'] = 'Ordenar';
$_lang['Order categories by'] = 'Ordenar categorías por';
$_lang['Order course by'] = 'Ordenar cursos por';
...
$_lang['Personal informations'] = 'Datos personales';
...
$_lang['Platform activation'] = 'Activación en la plataforma';
$_lang['Platform admin can export username, user_id and password'] = 'El administrador de la plataforma puede exportar nombres de usuario, identificadores y contraseñas';
$_lang['Platform administration'] = 'Administración de la plataforma';
$_lang['Platform administrator'] = 'Administrador de la plataforma';
$_lang['Platform courses'] = 'Cursos en la plataforma';
...
$_lang['Platform role'] = 'Rol en la plataforma';
$_lang['Platform settings'] = 'Opciones de plataforma';
$_lang['Platform statistics'] = 'Estadísticas de la plataforma';
$_lang['Platform web URL'] = 'URL de la plataforma';
$_lang['Platform\' configuration'] = 'Configuración de la plataforma';
...
$_lang['Please contact'] = 'Por favor, contacte con';
$_lang['Please contact course titular(s)'] = 'Por favor, contacte con el/los titular(es) del curso';
$_lang['Please contact the course manager : %email'] = 'Por favor, contacte con el coordinador del curso: %email';
$_lang['Please create a category first'] = 'Por favor, cree antes una categoría';
...
$_lang['Please try again.'] = 'Por favor, inténtelo de nuevo.';
...
$_lang['Portlet'] = 'Elemento de portada';
$_lang['Portlet created'] = 'Elemento de portada creado';
$_lang['Portlet deleted'] = 'Elemento de portada eliminado';
$_lang['Portlet moved down'] = 'Elemento de portada bajado';
$_lang['Portlet moved up'] = 'Elemento de portada subido';
$_lang['Portlet visibility modified'] = 'Cambiada visibilidad del elemento de portada';
...
$_lang['Prefix for course table  / db names'] = 'Prefijo para las tablas o bases de datos de los cursos';
$_lang['Prefix for empty code course'] = 'Prefix for empty code course';
$_lang['Prefix for main table names'] = 'Prefijo para los nombres de las tablas principales';
$_lang['Prefix for tracking table names'] = 'Prefijo para los nombres de las tablas de seguimiento';
$_lang['Preformated text'] = 'Texto preformateado';
$_lang['Presentation'] = 'Presentación';
$_lang['Pretty URL using PATH_INFO (download.php/path/to/file.ext)'] = 'URL adornado como una ruta (download.php/ruta/al/archivo.ext)';
...
$_lang['Private feedback'] = 'Revisión privada';
$_lang['Production language files'] = 'Archivos de producción (múltiples archivos)';
$_lang['Profile'] = 'Perfil';
$_lang['Profile SQL'] = 'Monitorizar SQL';
$_lang['Profile SQL in DEBUG MODE.
Display for each request :duration, counter,  statement '] = 'Monitorización de SQL en el modo de depuración. Muestra duración, contador, declaración de cada petición';
$_lang['Profile form'] = 'Ficha de usuario';
...
$_lang['Properties for %config_name, (%config_code) are now effective on server.'] = 'Las propiedades de «%config_name, (%config_code)» son ahora efectivas en el servidor.';
...
$_lang['Reactivate it'] = 'Reactivarlo';
$_lang['Read'] = 'Leer';
...
$_lang['Repository for cache files and dirs'] = 'Almacén de caché';
$_lang['Repository for temporary files and dirs'] = 'Repositorio para archivos y directorios temporales';
$_lang['Request'] = 'Petición';
$_lang['Request course creation status'] = 'Solicitud del estatus de Creador de Cursos';
$_lang['Request to remove this account'] = 'Solicitud de borrado de la cuenta';
$_lang['Required'] = 'Obligatorio';
...
$_lang['Right profile list'] = 'Lista de perfiles';
$_lang['Rights'] = 'Permisos';
$_lang['Role'] = 'Papel';
$_lang['Role in this course'] = 'Rol en este curso';
$_lang['Root'] = 'Raíz';
$_lang['Root category'] = 'Categoría principal';
...
$_lang['Rss feed for %course'] = 'Fuente RSS para %course';
$_lang['SCORM 1.2 conformable content'] = 'Contenido conforme con SCORM 1.2';
$_lang['SCORM conformant modules are definitively removed from server when deleted in their learning path.'] = 'Los módulos SCORM serán eliminados definitivamente cuando sean borrados en la secuencia de aprendizaje.';
$_lang['SDK'] = 'Herramientas de desarrollo';
$_lang['SMTP'] = 'SMTP';
$_lang['SMTP port'] = 'Puerto SMTP';
$_lang['SMTP security layer'] = 'Seguridad SMTP';
...
$_lang['Same display as in Claroline 1.9 (SC > PHYS) Physics instead of 1.10 Sciences > Physics. Useful if you have long category titles.'] = 'Como en Claroline 1.9 mostrar p. ej. «(CC > FIS) Física» en vez de «1.10 Ciencias > Física». Útil cuando se tienen nombres de categoría muy largos.';
...
$_lang['Search and add an existing user'] = 'Buscar usuario para inscribirlo';
$_lang['Search course'] = 'Buscar curso';
$_lang['Search for a course'] = 'Buscar curso';
$_lang['Search for a user'] = 'Buscar usuario';
...
$_lang['Seats'] = 'Puestos';
$_lang['SecondShort'] = 's.';
$_lang['Secondary manifest found in zip file :'] = 'Se halló un manifiesto secundario en el archivo zip :';
...
$_lang['Select interval'] = 'Seleccione intervalo de fechas';
...
$_lang['Select the way Claroline send files to a user.'] = 'Seleccione la forma en que Claroline entrega los archivos a un usuario.';
...
$_lang['Send account information to user by email'] = 'Enviarle información por correo electrónico';
$_lang['Send email to new users'] = 'Enviar correo electrónico a usuarios nuevos';
$_lang['Send file using PHP (mask real file location)'] = 'Enviar archivo usando PHP (oculta la ubicación real del archivo)';
$_lang['Send this announcement by internal message to registered students'] = 'Enviar el anuncio a los participantes por mensajería interna';
$_lang['Send this announcement to registered students'] = 'Enviar este anuncio a los participantes';
$_lang['Sender'] = 'De';
$_lang['Session'] = 'Sesión';
$_lang['Session courses list'] = 'Lista de sesiones del curso';
$_lang['Session lost warning'] = 'Advertencia de pérdida de la sesión';
$_lang['Set mysql charset'] = 'Fijar codificación de caracteres MySQL';
...
$_lang['Settings for tutors of group'] = 'Configuración para los tutores de grupo';
$_lang['Settings for users of group'] = 'Configuración para los miembros del grupo';
...
$_lang['Settings of the user course list'] = 'Configuración de la lista de cursos';
$_lang['Show'] = 'Mostrar';
...
$_lang['Show user profile page'] = 'Mostrar fichas de usuarios';
$_lang['Show wiki syntax toolbar'] = 'Mostrar la barra de herramientas de la sintaxis wiki';
$_lang['Show/Hide'] = 'Mostrar/Ocultar';
...
$_lang['Standard URL using QUERY_STRING (download.php?url=/path/to/file.ext)'] = 'URL estándar con opciones (download.php?url=/ruta/a/archivo.ext)';
$_lang['Start Module'] = 'Comenzar módulo';
$_lang['Start date'] = 'Fecha de inicio';
$_lang['Start date must be before end date ...'] = 'La fecha de inicio debe de ser anterior a la de finalización';
$_lang['Start of this chat session (%connectTime)'] = 'Comienzo de la conversación (%connectTime)';
...
$_lang['Statistics of exercise attempt'] = 'Estadísticas de intentos en los ejercicios';
$_lang['Statistics of question'] = 'Estadísticas de la pregunta';
$_lang['Status'] = 'Estatus';
$_lang['Store Chat'] = 'Guardar conversación';
...
$_lang['Subject cannot be empty'] = 'El asunto no puede quedar vacío';
$_lang['Subject couldn\'t be empty'] = 'El asunto no puede quedar vacío';
...
$_lang['Swap visibility'] = 'Modificar visibilidad';
$_lang['System Info'] = 'Información del sistema';
$_lang['System mail : recipients list'] = 'Notificaciones del sistema: lista de destinatarios';
$_lang['TLS/STARTTLS'] = 'TLS/STARTTLS';
$_lang['Take one of these options'] = 'Elija una de estas opciones';
$_lang['Target'] = 'Meta';
$_lang['Teacher can add a user in his course'] = 'El profesor puede agregar a un usuario en su curso';
$_lang['Teacher can export password'] = 'El profesor puede exportar las contraseñas';
$_lang['Teacher can export user id'] = 'El profesor puede exportar los identificadores de usuario';
$_lang['Teacher can export user list from his course'] = 'El profesor puede exportar las listas de usuarios de sus cursos';
$_lang['Teacher can export username'] = 'El profesor puede exportar los nombres de usuario';
$_lang['Teacher can import user list in his course'] = 'El profesor puede importar una lista de usuarios en su curso';
$_lang['Teachers are allowed to register whole classes to their courses'] = 'Los profesores pueden agregar clases enteras en sus cursos';
$_lang['Teachers can register new users to the campus'] = 'Los profesores pueden registrar a nuevos usuarios en la plataforma';
...
$_lang['Text displayed on the "Create user account" page'] = 'Texto que se muestra en la página «Crear cuenta de usuario»';
$_lang['Text displayed on the "My user account" page'] = 'Texto que se muestra en la página «Modificar mis datos»';
$_lang['Text displayed on the right column'] = 'Texto al pie de la columna derecha';
$_lang['Text only (text required, no file)'] = 'Solo texto (se requiere el texto, sin archivo)';
$_lang['Text top'] = 'Texto al inicio';
$_lang['Text with attached file (text required, file optional)'] = 'Texto con archivo adjunto (se requiere el texto, archivo opcional)';
...
$_lang['The exercise is not available'] = 'El ejercicio no está disponible';
...
$_lang['The following options will only work for course tool modules :'] = 'Las opciones siguientes son solo para módulos de herramientas de curso :';
...
$_lang['The message sent but the notification by'] = 'El mensaje enviado, pero la notificación por';
$_lang['The module has been removed from this dock'] = 'El módulo ha sido retirado de este apilamiento';
$_lang['The module will still be available in the pool of modules.'] = 'El módulo se conservará en el repositorio de módulos.';
$_lang['The name of the cookie. By default the name is "clarolineSsoCookie"'] = 'El nombre de la cookie. Por defecto el nombre es «clarolineSsoCookie»';
$_lang['The new category has been created.'] = 'Se ha creado la nueva categoría.';
$_lang['The new class has been created'] = 'Se ha creado la nueva clase';
$_lang['The new user has been sucessfully created'] = 'Se ha creado con éxito el nuevo usuario';
$_lang['The path on the server in which the cookie will be available on.  If set to "/", the cookie will be available within the entire domain. If set to "/foo/", the cookie will only be available within the /foo/ directory and all sub-directories such as /f'] = 'La ruta del servidor para la que la cookie estará disponible. Si se establece «/», la cookie estará disponible para todo el sitio. Si se establece «/loquesea/», la cookie solo estará disponible para el directorio «/loquesea/» y todos sus subdirectorios';
...
$_lang['This is probably a bad idea to set as hidden'] = 'Probablemente sea una mala idea dejarlos ocultos';
...
$_lang['This is the main page of the Wiki %s. Click on \'\'\'Edit\'\'\' to modify the content.'] = 'Ésta es la página de inicio del Wiki. Pulse «Editar» para modificar su contenido.';
$_lang['This is the main page of the Wiki %wikiTitle. Click on \'\'\'Edit\'\'\' to modify the content.'] = 'Ésta es la página principal del wiki %wikiTitle. Pulse «Editar» para modificar el contenido.';
...
$_lang['This is where tracking and statistics data are stored. This database can be the same as the main database.'] = 'Aquí es donde se almacenan los datos de seguimiento y estadísticas. Puede ser la misma base de datos principal.';
$_lang['This is your account Login-Pass'] = 'Éste es tu nombre de usuario y contraseña';
$_lang['This limit doesn\'t include course\'s tutors and managers'] = 'Este límite no incluye a tutores y gestores del curso';
...
'] = 'Inserta una opción en la ficha de usuario para pedir la baja en la plataforma. La petición se tramita por correo electrónico al administrador de la plataforma.
Esta opción solo se refiere a la petición en si y no presupone la respuesta en uno u otro sentido.';
...
$_lang['This password is too simple or too close to the username, first name or last name.<br> Use a password like this <code>%passProposed</code>'] = 'Contraseña demasiado simple o muy parecida al nombre de usuario, nombre o apellidos.<br> Utilice una contraseña mejor, como <code>%passProposed</code>';
$_lang['This portlet can\'t be moved down'] = 'Ese elemento de portada no se puede mover hacia abajo';
$_lang['This portlet can\'t be moved up'] = 'Ese elemento de portada no se puede mover hacia arriba';
$_lang['This prefix could allow to order more easily the tables / DB in the user interface of your server technical back office  '] = 'Este prefijo permite identificar fácilmente las tablas o bases de datos al administrador.';
$_lang['This question is used in several exercises.'] = 'Esta pregunta es muy utilizada en varios ejercicios.';
$_lang['This renderer is used for TEX/LaTEX expressions. It is available into the \'claroline/inc/lib/\' directory and has to be copied on a server location where CGI programs are expected.'] = 'Este procesador se emplea para las expresiones TEX/LaTEX. Está disponible en el directorio \'claroline/inc/lib/\' y se tiene que copiar a una ubicación del servidor web donde se permita la ejecución de programas CGI.';
...
$_lang['This tool is activable by the platform administrator only'] = 'Esta herramienta solo puede ser activada por el administrador de la plataforma';
$_lang['This tool must be activated manualy in each course'] = 'Esta herramienta tiene que ser activada a mano en cada curso';
$_lang['This topic has been deleted'] = 'El tema ha sido borrado';
$_lang['This topic is now locked'] = 'El tema está ahora bloqueado';
$_lang['This topic is now open to new contributions'] = 'El tema está ahora abierto para nuevas contribuciones';
$_lang['This user account is not active anymore in this course'] = 'El usuario ha quedado desactivado en este curso';
$_lang['This user account is now active in the course'] = 'This user account is now active in the course';
$_lang['This username is already taken'] = 'Ese nombre de usuario ya existe';
...
$_lang['Time before really compute data. 86400 seconds = 1 day.'] = 'Tiempo antes de que realmente se computen los datos. 86400 segundos = 1 día.';
...
In single db mode, IT CAN\'T be a dot.
';
$_lang['To send a message, select groups of users (marked with a * in the front) or single users from the list on the left.'] = 'Para enviar un mensaje, seleccione grupos de usuarios (con * delante)
o usuarios individuales desde la lista de la izquierda.';
$_lang['Today'] = 'Hoy';
...
$_lang['Unable to create file :'] = 'No ha sido posible crear el archivo :';
...
$_lang['Unable to create frame file'] = 'No ha sido posible crear el archivo de marco :';
...
$_lang['Unable to create zip file'] = 'No se puede crear el archivo ZIP';
...
$_lang['Unknown forum'] = 'Foro desconocido';
$_lang['Unknown post'] = 'Envío desconocido';
$_lang['Unknown post or edition mode'] = 'Unknown post or edition mode';
$_lang['Unknown question format in file %file'] = 'Formato de preguntas desconocido en el archivo %file';
...
$_lang['Upload document'] = 'Subir documento';
$_lang['Upload failed'] = 'Subida fallida';
$_lang['Upload file'] = 'Subir archivo';
$_lang['Uploaded file'] = 'Archivo subido';
$_lang['Uploaded file should be an image'] = 'El archivo subido debería ser una imagen';
...
$_lang['User id missing'] = 'Falta el identificador del usuario ';
$_lang['User is not valid'] = 'Usuario no válido';
$_lang['User is now course manager'] = 'El usuario es ahora coordinador del curso';
$_lang['User is now student for this course'] = 'El usuario es ahora participante en este curso';
$_lang['User list'] = 'Lista de usuarios';
$_lang['User list refresh time'] = 'Tiempo de refresco para usuarios';
...
$_lang['User registered in a course having an unexisting (deprecated) status'] = 'Usuario inscrito en un curso en estado inexistente (en desuso)';
$_lang['User registered to the course'] = 'Usuario registrado en el curso';
$_lang['User request'] = 'Peticiones de usuario';
$_lang['User settings'] = 'Editar usuario';
$_lang['User statistics'] = 'Estadísticas de usuario';
$_lang['User to keep not found'] = 'No se encuentra el usuario a mantener';
$_lang['User to remove not found'] = 'No se encuentra el usuario a eliminar';
$_lang['User tracking'] = 'Seguimiento';
$_lang['User unregistered'] = 'Usuario desinscrito';
$_lang['User unvalidated'] = 'Usuario invalidado';
$_lang['User validated'] = 'Usuario validado';
$_lang['User\'s course'] = 'Cursos del usuario';
$_lang['User\'s course settings'] = 'Configuración de los cursos del usuario';
$_lang['Username'] = 'Nombre de usuario';
$_lang['Username already exists in the database at line %key'] = 'El nombre de usuario en la línea %key ya existe en la base de datos';
...
$_lang['Username seems to be duplicate at line %key'] = 'Nombre de usuario en la línea %key aparece duplicado';
$_lang['UsernameAppearAlready'] = 'Este nombre de usuario aparece ya en una línea previa del archivo CSV.';
$_lang['UsernameUsed'] = 'Este nombre de usuario está siendo usado ya por otro usuario.';
$_lang['Users'] = 'Participantes';
...
$_lang['Users can send messages from outside a course context'] = 'Los usuarios pueden enviar mensajes desde fuera de los cursos';
$_lang['Users can submit after end date'] = 'Los usuarios pueden enviar después de la fecha de finalización';
$_lang['Users help'] = 'Ayuda a usuarios';
$_lang['Users in group'] = 'Participantes en el grupo';
$_lang['Users list'] = 'Lista de usuarios';
$_lang['Users not in this group'] = 'Participantes fuera del grupo.';
...
$_lang['Users\' Clicks'] = 'Total de clics de los participantes';
$_lang['Users\' pictures'] = 'Imágenes de los usuarios';
$_lang['UsersMin'] = 'usuarios';
$_lang['Validation'] = 'Validación';
...
$_lang['View all my messages'] = 'Ver todos mis mensajes';
$_lang['View all right profile'] = 'Ver todos los perfiles';
$_lang['View all user\'s posts'] = 'Ver todos los envíos del usuario';
...
$_lang['Visible - Click to make invisible'] = 'Visible - clic para hacer invisible';
$_lang['Visible for all users'] = 'Visible para todos los usuarios';
$_lang['Visible from'] = 'Visible desde';
...
$_lang['Visible in all courses on install <small>(this can take some time depending on the number of courses in your campus)</small>'] = 'Visible en todos los cursos tras la instalación <small>(esto puede tardar algo de tiempo según el número de cursos)</small>';
...
$_lang['Visible only to people on the user list'] = 'Visible solo a las personas en la lista de usuarios';
$_lang['Visible until'] = 'Visible hasta';
...
$_lang['Welcome text displayed on the homepage'] = 'Bienvenida mostrada en la página de inicio';
$_lang['Welcome text displayed to anonymous users'] = 'Bienvenida mostrada a usuarios anónimos';
$_lang['Welcome text displayed to authenticated users'] = 'Bienvenida mostrada a los usuarios autenticados';
...
$_lang['Wiki creation succeed'] = 'Creación de la wiki completada';
$_lang['Wiki deletion failed'] = 'El borrado de la wiki ha fallado';
$_lang['Wiki deletion succeed'] = 'Se ha completado la eliminación de la wiki';
$_lang['Wiki description'] = 'Descripción de la wiki';
$_lang['Wiki edition failed'] = 'La edición de la wiki ha fallado';
$_lang['Wiki edition succeed'] = 'Edición de la wiki completada';
...
$_lang['Works uploaded by the student in the name of \'Authors\''] = 'Trabajos subidos por los participantes como «Autores»';
$_lang['Worst score'] = 'Mínimo';
$_lang['Would you like to add one ?'] = '¿ Desea añadir uno ?';
$_lang['Wrong enrolment key'] = 'La contraseña de inscripción es errónea';
$_lang['Wrong operation'] = 'operación errónea';
$_lang['Wrong page title'] = 'El título de la página es erróneo ';
$_lang['Wrong parameters'] = 'Parámetros erróneos';
$_lang['Year'] = 'Año';
$_lang['Yes'] = 'Sí';
$_lang['Yes, allow users to submit works after end date'] = 'Sí, permitir a los usuarios enviar trabajos después de la fecha límite';
$_lang['Yes, create RDF version'] = 'Sí, crear la versión RDF';
$_lang['Yes, create XML version'] = 'Sí, crear la versión XML';
...
$_lang['You are not allowed to create a public course'] = 'Usted no tiene permiso para crear un curso público';
$_lang['You are not allowed to create pages'] = 'Usted no tiene permiso para crear páginas';
$_lang['You are not allowed to edit this page'] = 'Usted no tiene permiso para editar esta página';
...
$_lang['You cannot delete a category having sub categories'] = 'No se puede eliminar una categoría con subcategorías';
...
$_lang['You didnt choose any file to send, or file is too big'] = 'No seleccionó ningún archivo para enviar, o el archivo es demasiado grande';
...
$_lang['You must introduce the message text'] = 'Tiene que introducir el texto del mensaje.';
$_lang['You must reach the maximum number of allowed attempts to view these statistics.'] = 'Las estadísticas no son visibles hasta no superar el número máximo de intentos permitidos.';
$_lang['You must select a file'] = 'Tiene que seleccionar un archivo';
$_lang['You must select a text file'] = 'You must select a text file';
$_lang['You must select some users'] = 'Tiene que seleccionar algún usuario.';
$_lang['You must specify the CSV format used in your file'] = 'Es necesario conocer la estructura del archivo CSV a importar';
$_lang['You must upload a zip file'] = 'Tiene que subir un archivo ZIP';
$_lang['You need to be authenticated with your %sitename account'] = 'Tiene que autentificarse con una cuenta de %sitename';
...
$_lang['Your contribution has been recorded'] = 'El comentario ha quedado registrado';
...
<ul>
	...
	<li> una descripción : la presentación del trabajo, lo que los estudiantes tienen
	que hacer</li>
	<li> un tipo de envío :
		<ul>
	...
	<li> el tipo de tarea :
		<ul>
			<li> individual : solo los usuarios autentificados podrán realizar publicaciones</li>
...
<p>Puede ser un texto, o un archivo, o ambos. El gestor del curso puede escoger cuando le debe de ser enviada a los
...
<ul>
	...
	<li> <strong>Añadir corrección</strong> :
		...
		puede ser un archivo, un texto o ambos, con un comentario privado que solo será visible para el(los)
...
Se ha creado un curso en %sitename por el usuario %user_firstname %user_lastname ( %user_email )

Código del curso : %course_code
Nombre del curso : %course_title
Profesores : %course_lecturers
Correo electrónico : %course_email
Categoría : %course_categories
...
$_lang['blockCourseSettingsTip'] = 'Inicialmente el creador del curso es el único participante y el curso
solamente será accesible por usted. Si desea una mínima confidencialidad, lo más simple es abrir
la inscripción durante una semana, pedir a los futuros participantes que se inscriban ellos mismos y
después cerrar la inscripción y verificar la lista de los usuarios en busca de los eventuales intrusos.';
$_lang['blockCourseSubscriptionNotification'] = 'Hola %firstname %lastname,

Uno de los administradores del curso «%courseName» le ha inscrito en este curso.

La dirección del curso es: %coursePath
...
$_lang['blockDocumentsHelp'] = '<p>El módulo de gestión de documentos funciona de manera semejante a la gestión
					...
					<ul>
					  <li>Haga clic en el botón <img src=../document/img/edit.gif width=20 height=20 align=baseline>
					  ...
					  <li>Validar haciendo clic en &quot;OK&quot;
					  ...
					  <li>Haga clic en el botón <img src=../document/img/delete.gif width=20 height=20>
						en la columna &quot;Borrar&quot;.</li>
						</ul>
						<h4>Hacer que un documento sea invisible para los estudiantes (o un directorio)</h4>
						<ul>

					  <li>Haga clic en el botón <img src=../document/img/visible.gif width=20 height=20>
					  ...
					  <li>Si ustede desea que este elemento vuelva a ser visible,
						haga clic en el botón <img src=../img/invisible.gif width=24 height=20>
						en la columna &quot;Visible/invisible&quot;</li>
						</ul>
						<h4>Añadir o modificar un comentario a un documento (o a un directorio)</h4>
						<ul>

					  <li>Haga clic en el botón  <img src=../img/comment.gif width=20 height=20>
						en la columna &quot;Commentario&quot;</li>
						  ...
						  <li>Valide haciendo clic en &quot;OK&quot;
							<input type=submit value=OK name=submit2>
							.</li>
						</ul>
						<p>Si usted desea borrar un comentario, haga clic en el botón <img src=../img/comment.gif width=20 height=20>,
						  &quot;borrar el antiguo comentario de la zona&quot; y valide haciendo clic en &quot;OK&quot;
						...
						<ul>
						  <li>Hacer clic en la función &quot;<img src=../img/folder.gif>crear
						...
						<ul>
						  <li>Haga clic sobre el botón <img src=../img/deplacer.gif width=34 height=16>
...
<p>Para modificar un ejercicio, siga los mismos pasos que hizo para crearlo. Solo pulse en la imagen <img src="img/edit.gif" border="0" align="absmiddle"> al lado del ejercicio que quiere
...
Si Vd. tiene un número elevado de preguntas, también puede hacer que aparezcan solo X preguntas
...
<p>Rellenar grupos, tanto de forma manual o automática solo es efectivo si hay estudiantes registrados
en el curso (no confunda registro en el curso con registro en los grupos).
La lista de estudiantes es visible en el módulo <b>Participantes</b>.</p><hr noshade size=1>
...
$_lang['blockIntroCourse'] = '<br />Está usted en la página de inicio o página principal del curso.<br /><br />En esta página, usted puede:
<ul>
<li>Agregar elementos de portada a esta página principal (enlaces encima de esta ayuda).</li>
<li>Activar o desactivar herramientas («Editar lista de herramientas», menú a la izquierda y abajo).</li>
<li>Cambiar la configuración o ver las estadísticas del curso (menú a la izquierda y más abajo).</li>
</ul>';
...
Comentarios : %comment
Enlace : %url';
$_lang['blockTextZoneHelp'] = 'Esta zona de texto se muestra a todos los usuarios. El administrador de la plataforma puede cambiar su contenido o eliminarlo editando el archivo
 <b>%textZoneFile</b>.';
...
No otorgan ningún derecho sobre el sistema. Usted puede modificarlos haciendo clic sobre \'modificar\' debajo de
\'rol/papel\' e introduciendo después todas las letras de la descripción de la función conveniente:
profesor, asistente, tutor, visitante, documentalista, experto, moderador... Esto servirá solo para indicar
...
<li>Puede usted también pulsar en \'Cancelar\' para anular sus cambios.</li>
</ul></p>';
$_lang['blockWikiHelpAdminContent'] = '<h3>Ayuda a la administración del Wiki</h3>
<dl class="wikiHelp">
<dt>¿Cómo se puede crear un nuevo Wiki?</dt>
...
<li><b>Miembros de grupo</b> (disponible solo dentro de un grupo) : los usuarios que son miembros del grupo
...
y añádale <code>[título de la página</code> o <code>[título de la
página|texto del enlace]</code> a su contenido. Usted puede también emplear esta sintaxis para cambiar el texto
...
$_lang['forbidden'] = 'prohibido';
$_lang['from'] = 'de';
$_lang['good looking'] = 'guapo(a)';
$_lang['hide'] = 'hide';
$_lang['high resources'] = 'high resources';
$_lang['iCal feed for %course'] = 'Fuente iCal para %course';
$_lang['iCal generator'] = 'Generador iCal';
$_lang['included'] = 'incluido';
$_lang['int'] = 'entero';
...
$_lang['sampleForumMessage'] = 'En el momento que usted suprima el foro &quot;Foro de pruebas&quot;, se borrará también el presente tema que no contiene más que este mensaje.';
$_lang['sampleForumTitle'] = 'Foro de pruebas';
$_lang['sampleForumTopicTitle'] = 'Mensaje de ejemplo';
$_lang['sampleLearnPathDescription'] = 'Este es un ejemplo de secuencia de aprendizaje. Se utiliza en el ejercicio de muestra y en el documento de muestra de la herramienta de ejercicios y la herramienta de documentos. Pulse <b>Modificar</b> para cambiar este texto.';
...
$_lang['send new password by email'] = 'Enviar cada contraseña por correo electrónico';
$_lang['show'] = 'show';
